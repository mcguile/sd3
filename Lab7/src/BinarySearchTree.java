public class BinarySearchTree {
	private class BSTNode{ //private class to hold a tree node
		...
		public DLinkedList dLInOrderTraversal(DLinkedList dl){
			if (this.leftChild != null) 
				this.leftChild.dLInOrderTraversal(dl);
			dl.addAtTail(this.getValue());
			if (this.rightChild != null) 
				this.rightChild.dLInOrderTraversal(dl);
			return dl;
		}
	...
	public DLinkedList returnInOrderTraversal(){
		...
		if (rootNode != null)
			dl = rootNode.dLInOrderTraversal(dl);
		return dl;
	}
